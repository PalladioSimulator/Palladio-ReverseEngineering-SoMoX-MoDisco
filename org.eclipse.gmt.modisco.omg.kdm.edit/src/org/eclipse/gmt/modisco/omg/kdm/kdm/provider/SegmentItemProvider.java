...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.kdm.Segment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SegmentItemProvider
	extends KDMFrameworkItemProvider
	implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(KdmPackage.Literals.SEGMENT__SEGMENT);
			childrenFeatures.add(KdmPackage.Literals.SEGMENT__MODEL);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(KdmPackage.Literals.SEGMENT__SEGMENT,
				 KdmFactory.eINSTANCE.createSegment()));

		newChildDescriptors.add
			(createChildParameter
				(KdmPackage.Literals.SEGMENT__MODEL,
				 SourceFactory.eINSTANCE.createInventoryModel()));

		newChildDescriptors.add
			(createChildParameter
				(KdmPackage.Literals.SEGMENT__MODEL,
				 CodeFactory.eINSTANCE.createCodeModel()));

		newChildDescriptors.add
			(createChildParameter
				(KdmPackage.Literals.SEGMENT__MODEL,
				 PlatformFactory.eINSTANCE.createPlatformModel()));

		newChildDescriptors.add
			(createChildParameter
				(KdmPackage.Literals.SEGMENT__MODEL,
				 BuildFactory.eINSTANCE.createBuildModel()));

		newChildDescriptors.add
			(createChildParameter
				(KdmPackage.Literals.SEGMENT__MODEL,
				 ConceptualFactory.eINSTANCE.createConceptualModel()));

		newChildDescriptors.add
			(createChildParameter
				(KdmPackage.Literals.SEGMENT__MODEL,
				 DataFactory.eINSTANCE.createDataModel()));

		newChildDescriptors.add
			(createChildParameter
				(KdmPackage.Literals.SEGMENT__MODEL,
				 EventFactory.eINSTANCE.createEventModel()));

		newChildDescriptors.add
			(createChildParameter
				(KdmPackage.Literals.SEGMENT__MODEL,
				 StructureFactory.eINSTANCE.createStructureModel()));

		newChildDescriptors.add
			(createChildParameter
				(KdmPackage.Literals.SEGMENT__MODEL,
				 UiFactory.eINSTANCE.createUIModel()));
	}
