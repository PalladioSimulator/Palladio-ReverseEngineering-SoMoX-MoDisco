...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.code.CompilationUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompilationUnitItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CompilationUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_CompilationUnit_type") : //$NON-NLS-1$
			getString("_UI_CompilationUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
