...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.event.EventElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventElementItemProvider
	 ...
	 * @generated
	 */
	public EventElementItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EventElement")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((EventElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EventElement_type") : //$NON-NLS-1$
			getString("_UI_EventElement_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EventElement.class)) {
