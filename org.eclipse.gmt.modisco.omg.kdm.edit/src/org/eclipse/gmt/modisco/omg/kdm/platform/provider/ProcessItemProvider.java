...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.platform.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider
	...
	public String getText(Object object) {
		String label = ((org.eclipse.gmt.modisco.omg.kdm.platform.Process)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Process_type") : //$NON-NLS-1$
