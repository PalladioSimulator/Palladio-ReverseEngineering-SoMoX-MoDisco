...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.code.InterfaceUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceUnitItemProvider
	 ...
	 * @generated
	 */
	public InterfaceUnitItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CodePackage.Literals.INTERFACE_UNIT__CODE_ELEMENT);
		}
	...
	/**
	 * This returns InterfaceUnit.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InterfaceUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((InterfaceUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_InterfaceUnit_type") : //$NON-NLS-1$
			getString("_UI_InterfaceUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InterfaceUnit.class)) {
			case CodePackage.INTERFACE_UNIT__CODE_ELEMENT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CodePackage.Literals.INTERFACE_UNIT__CODE_ELEMENT,
