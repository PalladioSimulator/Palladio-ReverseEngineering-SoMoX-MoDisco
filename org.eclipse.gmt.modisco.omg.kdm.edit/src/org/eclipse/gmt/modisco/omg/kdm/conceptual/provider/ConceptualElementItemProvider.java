...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.conceptual.ConceptualElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConceptualElementItemProvider
	 ...
	 * @generated
	 */
	public ConceptualElementItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns ConceptualElement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConceptualElement")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((ConceptualElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ConceptualElement_type") : //$NON-NLS-1$
			getString("_UI_ConceptualElement_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConceptualElement.class)) {
