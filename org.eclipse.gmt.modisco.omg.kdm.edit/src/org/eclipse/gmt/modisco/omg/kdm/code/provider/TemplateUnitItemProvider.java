...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.code.TemplateUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TemplateUnitItemProvider
	 ...
	 * @generated
	 */
	public TemplateUnitItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CodePackage.Literals.TEMPLATE_UNIT__CODE_ELEMENT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TemplateUnit")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((TemplateUnit)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TemplateUnit_type") : //$NON-NLS-1$
			getString("_UI_TemplateUnit_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TemplateUnit.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CodePackage.Literals.TEMPLATE_UNIT__CODE_ELEMENT,
