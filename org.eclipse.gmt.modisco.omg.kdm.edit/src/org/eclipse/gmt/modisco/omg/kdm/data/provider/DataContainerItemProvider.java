...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.data.DataContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataContainerItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DataPackage.Literals.DATA_CONTAINER__DATA_ELEMENT);
		}
	...
	/**
	 * This returns DataContainer.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DataContainer")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DataContainer)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DataContainer_type") : //$NON-NLS-1$
			getString("_UI_DataContainer_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DataPackage.Literals.DATA_CONTAINER__DATA_ELEMENT,
