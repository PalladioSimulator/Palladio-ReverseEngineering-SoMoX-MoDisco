...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.event.EventAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventActionItemProvider
	...
	protected void addKindPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EventAction_kind_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_EventAction_kind_feature", "_UI_EventAction_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 EventPackage.Literals.EVENT_ACTION__KIND,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EventPackage.Literals.EVENT_ACTION__EVENT_ELEMENT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EventAction")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_EventAction_type") : //$NON-NLS-1$
			getString("_UI_EventAction_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EventPackage.Literals.EVENT_ACTION__EVENT_ELEMENT,
