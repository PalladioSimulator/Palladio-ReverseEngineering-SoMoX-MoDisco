...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.structure.StructureElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StructureElementItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StructureElement")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_StructureElement_type") : //$NON-NLS-1$
			getString("_UI_StructureElement_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
