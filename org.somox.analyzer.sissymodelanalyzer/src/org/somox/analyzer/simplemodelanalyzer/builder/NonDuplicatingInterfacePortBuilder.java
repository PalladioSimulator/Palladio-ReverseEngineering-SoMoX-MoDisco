...
public class NonDuplicatingInterfacePortBuilder extends AbstractBuilder implements IRoleBuilderStrategy {
    ...
    public NonDuplicatingInterfacePortBuilder(final Root gastModel,
            final SoMoXConfiguration somoxConfiguration, final AnalysisResult analysisResult,
            final ComponentAndTypeNaming componentTypeNaming) {
    ...
    public List<OperationProvidedRole> buildProvidedRole(
        ...
        if(componentLink.getComponent() instanceof ComposedStructure) {
            ...
            final Iterable<SubComponentInformation> interfaceLinksNotUsedInConnectors = InterfacePortBuilderHelper.collectInformationOnNonBoundInterfaces(
    ...
    private OperationProvidedRole createProvidedRoleAndConnector(
        ...
        if(providedRole == null) {
            ...
            if(subComponentInformation.getInterfaceSourceCodeLink().getInterface() != null) {
                final InterfaceSourceCodeLink newInterfaceLink = SourceCodeDecoratorFactory.eINSTANCE.createInterfaceSourceCodeLink();
                ...
                final SourceCodeDecoratorRepository parentRepository = (SourceCodeDecoratorRepository) compositeComponentLink.eContainer();
    ...
    private OperationRequiredRole createRequiredRoleAndConnector(
        ...
        final Set<Interface> allRequiredInterfaces = collectInterfacesForComponent(compositeComponentLink, false);
        ...
        if(!allRequiredInterfaces.contains(linkedInterface)) { //avoid duplicate interfaces
            ...
            // query existing port
            for(final RequiredRole currentRequiredRole : compositeComponentLink.getComponent().getRequiredRoles_InterfaceRequiringEntity()) {
