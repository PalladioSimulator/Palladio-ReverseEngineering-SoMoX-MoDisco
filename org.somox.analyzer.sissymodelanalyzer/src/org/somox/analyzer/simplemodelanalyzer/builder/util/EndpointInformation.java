 ...
 * creation to inner components. An EndpointInformation stores
 * all information to identify an endpoint of a connector on a component.
 * An endpoint can be a provided role or required role offered by a
 * component instance identified by its assembly context.
 */
public class EndpointInformation {
    ...
    public EndpointInformation(
            final InterfaceSourceCodeLink interfaceSourceCodeLink,
            final Role role,
