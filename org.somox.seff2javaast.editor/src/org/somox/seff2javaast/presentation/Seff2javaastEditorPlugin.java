...
/**
 * This is the central singleton for the Seff2javaast editor plugin. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public final class Seff2javaastEditorPlugin extends EMFPlugin {
    /**
     * Keep track of the singleton. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    public static final Seff2javaastEditorPlugin INSTANCE = new Seff2javaastEditorPlugin();
