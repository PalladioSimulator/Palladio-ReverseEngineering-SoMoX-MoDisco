 ...
 * @generated
 */
public class Seff2methodAdapterFactory extends AdapterFactoryImpl {
    /**
     * The cached model package. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    protected static Seff2methodPackage modelPackage;
     ...
     * @generated
     */
    public Seff2methodAdapterFactory() {
        if (modelPackage == null) {
            modelPackage = Seff2methodPackage.eINSTANCE;
        }
    }
     ...
     * @generated
     */
    protected Seff2methodSwitch<Adapter> modelSwitch = new Seff2methodSwitch<Adapter>() {
        @Override
        public Adapter caseSEFF2MethodMapping(final SEFF2MethodMapping object) {
            return Seff2methodAdapterFactory.this.createSEFF2MethodMappingAdapter();
        }

        @Override
        public Adapter caseSEFF2JavaAST(final SEFF2JavaAST object) {
            return Seff2methodAdapterFactory.this.createSEFF2JavaASTAdapter();
        }

        @Override
        public Adapter defaultCase(final EObject object) {
            return Seff2methodAdapterFactory.this.createEObjectAdapter();
        }
    };
