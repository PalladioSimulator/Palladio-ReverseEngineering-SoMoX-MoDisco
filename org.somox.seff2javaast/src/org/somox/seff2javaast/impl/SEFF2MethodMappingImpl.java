...
public class SEFF2MethodMappingImpl extends EObjectImpl implements SEFF2MethodMapping {
            ...
            if (this.blockstatement != oldBlockstatement) {
                if (this.eNotificationRequired()) {
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            Seff2methodPackage.SEFF2_METHOD_MAPPING__BLOCKSTATEMENT, oldBlockstatement,
                            this.blockstatement));
                }
            }
        }
    ...
    public void setBlockstatement(final Block newBlockstatement) {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET,
                    Seff2methodPackage.SEFF2_METHOD_MAPPING__BLOCKSTATEMENT, oldBlockstatement, this.blockstatement));
        }
    }
    ...
    public ServiceEffectSpecification getSeff() {
        if (this.seff != null && ((EObject) this.seff).eIsProxy()) {
            ...
            if (this.seff != oldSeff) {
                if (this.eNotificationRequired()) {
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            Seff2methodPackage.SEFF2_METHOD_MAPPING__SEFF, oldSeff, this.seff));
                }
            }
        }
        return this.seff;
    ...
    public void setSeff(final ServiceEffectSpecification newSeff) {
        ...
        this.seff = newSeff;
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET, Seff2methodPackage.SEFF2_METHOD_MAPPING__SEFF,
                    oldSeff, this.seff));
        }
    }
