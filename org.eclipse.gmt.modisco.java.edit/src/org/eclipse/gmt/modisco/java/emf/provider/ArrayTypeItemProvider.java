...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.java.ArrayType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ArrayType_dimensions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ArrayType_dimensions_feature", "_UI_ArrayType_type"),
				 JavaPackage.eINSTANCE.getArrayType_Dimensions(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JavaPackage.eINSTANCE.getArrayType_ElementType());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JavaPackage.eINSTANCE.getArrayType_ElementType(),
