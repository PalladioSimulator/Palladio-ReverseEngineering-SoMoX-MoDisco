...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.java.AnnotationMemberValuePair} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotationMemberValuePairItemProvider
	 ...
	 * @generated
	 */
	public AnnotationMemberValuePairItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AnnotationMemberValuePair_member_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AnnotationMemberValuePair_member_feature", "_UI_AnnotationMemberValuePair_type"),
				 JavaPackage.eINSTANCE.getAnnotationMemberValuePair_Member(),
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JavaPackage.eINSTANCE.getAnnotationMemberValuePair_Value());
		}
	...
	/**
	 * This returns AnnotationMemberValuePair.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AnnotationMemberValuePair"));
	}
	...
	public String getText(Object object) {
		String label = ((AnnotationMemberValuePair)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AnnotationMemberValuePair_type") :
			getString("_UI_AnnotationMemberValuePair_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AnnotationMemberValuePair.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JavaPackage.eINSTANCE.getAnnotationMemberValuePair_Value(),
