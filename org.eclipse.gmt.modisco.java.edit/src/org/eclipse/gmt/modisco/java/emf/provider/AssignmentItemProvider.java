...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.java.Assignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssignmentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JavaPackage.eINSTANCE.getAssignment_Operator(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JavaPackage.eINSTANCE.getAssignment_LeftHandSide());
			childrenFeatures.add(JavaPackage.eINSTANCE.getAssignment_RightHandSide());
		}
	...
	public String getText(Object object) {
		AssignmentKind labelValue = ((Assignment)object).getOperator();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JavaPackage.eINSTANCE.getAssignment_LeftHandSide(),
		...
		newChildDescriptors.add
			(createChildParameter
				(JavaPackage.eINSTANCE.getAssignment_RightHandSide(),
				 JavaFactory.eINSTANCE.createAnnotation()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == JavaPackage.eINSTANCE.getAssignment_LeftHandSide() ||
			childFeature == JavaPackage.eINSTANCE.getAssignment_RightHandSide();
