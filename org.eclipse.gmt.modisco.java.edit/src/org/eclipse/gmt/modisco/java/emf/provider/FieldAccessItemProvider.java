...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.java.FieldAccess} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FieldAccessItemProvider
	 ...
	 * @generated
	 */
	public FieldAccessItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JavaPackage.eINSTANCE.getFieldAccess_Field());
			childrenFeatures.add(JavaPackage.eINSTANCE.getFieldAccess_Expression());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FieldAccess"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_FieldAccess_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FieldAccess.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JavaPackage.eINSTANCE.getFieldAccess_Field(),
				 JavaFactory.eINSTANCE.createSingleVariableAccess()));

		newChildDescriptors.add
			(createChildParameter
				(JavaPackage.eINSTANCE.getFieldAccess_Expression(),
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == JavaPackage.eINSTANCE.getFieldAccess_Field() ||
			childFeature == JavaPackage.eINSTANCE.getFieldAccess_Expression();
