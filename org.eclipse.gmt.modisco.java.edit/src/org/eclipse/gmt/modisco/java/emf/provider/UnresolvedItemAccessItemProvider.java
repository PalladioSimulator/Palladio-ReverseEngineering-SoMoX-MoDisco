	...
	protected void addQualifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UnresolvedItemAccess_qualifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UnresolvedItemAccess_qualifier_feature", "_UI_UnresolvedItemAccess_type"),
