...
public abstract class AbstractMetric implements IMetric {
     ...
     */
    protected Set<Type> calculateUnion(final Set<Type> classes1, final Set<Type> classes2) {
        final Set<Type> allInnerClasses = new HashSet<Type>(classes1);
     ...
     */
    protected Set<Type> calculateUnion(final ComponentImplementingClassesLink component1, final ComponentImplementingClassesLink component2) {
