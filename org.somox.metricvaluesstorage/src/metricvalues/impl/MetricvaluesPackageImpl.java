...
public class MetricvaluesPackageImpl extends EPackageImpl implements MetricvaluesPackage
{
   ...
   public void initializePackageContents()
   {
		...
		initEReference(getComponent_Classes(), theJavaPackage.getType(), null, "classes", null, 0, -1, Component.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
