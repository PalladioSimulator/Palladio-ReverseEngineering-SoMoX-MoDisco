...
/**
 * This is the action bar contributor for the SourceCodeDecorator model editor. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class SourceCodeDecoratorActionBarContributor extends EditingDomainActionBarContributor
    ...
    protected IAction showPropertiesViewAction = new Action(
            SourcecodedecoratorEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
                SourceCodeDecoratorActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
    ...
    protected IAction refreshViewerAction = new Action(
            SourcecodedecoratorEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
        public boolean isEnabled() {
            return SourceCodeDecoratorActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (SourceCodeDecoratorActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) SourceCodeDecoratorActionBarContributor.this.activeEditorPart)
                        .getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                SourcecodedecoratorEditorPlugin.INSTANCE.getString("_UI_SourceCodeDecoratorEditor_menu"),
                "org.somox.sourcecodedecoratorMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                SourcecodedecoratorEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                SourcecodedecoratorEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
