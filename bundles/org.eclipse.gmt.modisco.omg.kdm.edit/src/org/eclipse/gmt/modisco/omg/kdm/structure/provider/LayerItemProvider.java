...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.structure.Layer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LayerItemProvider
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_Layer_type") : //$NON-NLS-1$
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Layer.class)) {
			case StructurePackage.LAYER__AGGREGATED:
			case StructurePackage.LAYER__STRUCTURE_ELEMENT:
			case StructurePackage.LAYER__STRUCTURE_RELATIONSHIP:
