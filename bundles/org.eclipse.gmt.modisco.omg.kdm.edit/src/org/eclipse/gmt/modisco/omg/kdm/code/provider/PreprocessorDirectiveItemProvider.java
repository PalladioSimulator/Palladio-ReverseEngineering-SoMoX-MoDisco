...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.code.PreprocessorDirective} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PreprocessorDirectiveItemProvider
	 ...
	 * @generated
	 */
	public PreprocessorDirectiveItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CodePackage.Literals.PREPROCESSOR_DIRECTIVE__CODE_ELEMENT);
		}
	...
	/**
	 * This returns PreprocessorDirective.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PreprocessorDirective")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((PreprocessorDirective)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PreprocessorDirective_type") : //$NON-NLS-1$
			getString("_UI_PreprocessorDirective_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PreprocessorDirective.class)) {
			case CodePackage.PREPROCESSOR_DIRECTIVE__CODE_ELEMENT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CodePackage.Literals.PREPROCESSOR_DIRECTIVE__CODE_ELEMENT,
