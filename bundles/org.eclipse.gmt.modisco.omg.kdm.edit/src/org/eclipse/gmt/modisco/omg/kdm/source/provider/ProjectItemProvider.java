...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.source.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectItemProvider
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_Project_type") : //$NON-NLS-1$
			getString("_UI_Project_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
