...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.structure.Subsystem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubsystemItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Subsystem")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_Subsystem_type") : //$NON-NLS-1$
			getString("_UI_Subsystem_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Subsystem.class)) {
			case StructurePackage.SUBSYSTEM__AGGREGATED:
			case StructurePackage.SUBSYSTEM__STRUCTURE_ELEMENT:
			case StructurePackage.SUBSYSTEM__STRUCTURE_RELATIONSHIP:
