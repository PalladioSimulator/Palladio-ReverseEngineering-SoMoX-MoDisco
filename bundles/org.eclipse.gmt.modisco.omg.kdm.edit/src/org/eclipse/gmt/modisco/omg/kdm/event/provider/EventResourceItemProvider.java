...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.event.EventResource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventResourceItemProvider
	 ...
	 * @generated
	 */
	public EventResourceItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EventPackage.Literals.EVENT_RESOURCE__EVENT_ELEMENT);
		}
	...
	/**
	 * This returns EventResource.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EventResource")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((EventResource)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EventResource_type") : //$NON-NLS-1$
			getString("_UI_EventResource_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EventResource.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EventPackage.Literals.EVENT_RESOURCE__EVENT_ELEMENT,
