...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.source.InventoryModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InventoryModelItemProvider
	 ...
	 * @generated
	 */
	public InventoryModelItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SourcePackage.Literals.INVENTORY_MODEL__INVENTORY_ELEMENT);
		}
	...
	/**
	 * This returns InventoryModel.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InventoryModel")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((InventoryModel)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_InventoryModel_type") : //$NON-NLS-1$
			getString("_UI_InventoryModel_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InventoryModel.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SourcePackage.Literals.INVENTORY_MODEL__INVENTORY_ELEMENT,
