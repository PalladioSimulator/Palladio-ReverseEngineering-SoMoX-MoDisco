...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.build.Tool} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ToolItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Tool")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_Tool_type") : //$NON-NLS-1$
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Tool.class)) {
			case BuildPackage.TOOL__BUILD_RELATION:
