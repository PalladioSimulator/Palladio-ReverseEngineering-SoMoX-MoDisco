...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.platform.DataManager} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataManagerItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DataManager")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_DataManager_type") : //$NON-NLS-1$
			getString("_UI_DataManager_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
