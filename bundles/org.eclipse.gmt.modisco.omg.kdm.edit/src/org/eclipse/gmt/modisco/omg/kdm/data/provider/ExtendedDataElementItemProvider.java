...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.data.ExtendedDataElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExtendedDataElementItemProvider
	 ...
	 * @generated
	 */
	public ExtendedDataElementItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns ExtendedDataElement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExtendedDataElement")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((ExtendedDataElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ExtendedDataElement_type") : //$NON-NLS-1$
			getString("_UI_ExtendedDataElement_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ExtendedDataElement.class)) {
