...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.structure.SoftwareSystem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SoftwareSystemItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SoftwareSystem")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_SoftwareSystem_type") : //$NON-NLS-1$
			getString("_UI_SoftwareSystem_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
