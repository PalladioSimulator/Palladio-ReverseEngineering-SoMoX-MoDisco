...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.omg.kdm.conceptual.ConceptualRole} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConceptualRoleItemProvider
	 ...
	 * @generated
	 */
	public ConceptualRoleItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addConceptualElementPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Conceptual Element feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addConceptualElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConceptualRole_conceptualElement_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_ConceptualRole_conceptualElement_feature", "_UI_ConceptualRole_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 ConceptualPackage.Literals.CONCEPTUAL_ROLE__CONCEPTUAL_ELEMENT,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns ConceptualRole.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConceptualRole")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((ConceptualRole)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ConceptualRole_type") : //$NON-NLS-1$
			getString("_UI_ConceptualRole_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConceptualRole.class)) {
