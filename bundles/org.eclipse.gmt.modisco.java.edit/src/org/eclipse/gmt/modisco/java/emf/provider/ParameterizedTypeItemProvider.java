...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.java.ParameterizedType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterizedTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JavaPackage.eINSTANCE.getParameterizedType_Type());
			childrenFeatures.add(JavaPackage.eINSTANCE.getParameterizedType_TypeArguments());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JavaPackage.eINSTANCE.getParameterizedType_Type(),
				 JavaFactory.eINSTANCE.createTypeAccess()));

		newChildDescriptors.add
			(createChildParameter
				(JavaPackage.eINSTANCE.getParameterizedType_TypeArguments(),
				 JavaFactory.eINSTANCE.createTypeAccess()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == JavaPackage.eINSTANCE.getParameterizedType_Type() ||
			childFeature == JavaPackage.eINSTANCE.getParameterizedType_TypeArguments();
