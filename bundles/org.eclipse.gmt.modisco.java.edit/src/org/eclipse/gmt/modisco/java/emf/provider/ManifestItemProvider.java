...
public class ManifestItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JavaPackage.eINSTANCE.getManifest_MainAttributes());
			childrenFeatures.add(JavaPackage.eINSTANCE.getManifest_EntryAttributes());
		}
	...
	public String getText(Object object) {
		return getString("_UI_Manifest_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JavaPackage.eINSTANCE.getManifest_MainAttributes(),
				 JavaFactory.eINSTANCE.createManifestAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(JavaPackage.eINSTANCE.getManifest_EntryAttributes(),
				 JavaFactory.eINSTANCE.createManifestEntry()));
	}
