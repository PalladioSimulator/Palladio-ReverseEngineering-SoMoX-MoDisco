...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.java.FieldDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FieldDeclarationItemProvider
	...
	public String getText(Object object) {
		String label = ((FieldDeclaration)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_FieldDeclaration_type") :
			getString("_UI_FieldDeclaration_type") + " " + label;
	}
