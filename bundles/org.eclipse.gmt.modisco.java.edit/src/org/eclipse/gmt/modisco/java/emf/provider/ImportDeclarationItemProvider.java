...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmt.modisco.java.ImportDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ImportDeclaration_static_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ImportDeclaration_static_feature", "_UI_ImportDeclaration_type"),
				 JavaPackage.eINSTANCE.getImportDeclaration_Static(),
				 true,
				 false,
				 false,
	...
	protected void addImportedElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ImportDeclaration_importedElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ImportDeclaration_importedElement_feature", "_UI_ImportDeclaration_type"),
				 JavaPackage.eINSTANCE.getImportDeclaration_ImportedElement(),
				 true,
				 false,
				 true,
				 null,
