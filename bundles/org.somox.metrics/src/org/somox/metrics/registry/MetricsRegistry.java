...
public class MetricsRegistry {
    ...
    private static Map<MetricID, IMetric> internalGetRegisteredMetrics() {
        ...
        final IConfigurationElement[] metricExtensions = Platform.getExtensionRegistry().getConfigurationElementsFor(
    ...
    private static void parseMetricDefinitionModel(final Map<MetricID, IMetric> allMetrics,
        ...
        final MetricModel metricDefinitions = loadResource(metricExtension.getContributor().getName() + "/"
                + resourcePath);
    ...
    private static void parseBasicMetric(final Map<MetricID, IMetric> allMetrics,
        ...
        try {
            ...
            .getDefault()
            .getLog()
            .log(new Status(Status.ERROR, Activator.PLUGIN_ID, "Warning: Specified Analyzer Metric "
                    + metricExtension.getName() + " cannot be loaded."));
    ...
    private static IMetric parseMetricDefintion(final Map<MetricID, IMetric> allMetrics, final Metric metric) {
