...
public class AssemblyConnectorBuilder extends AbstractBuilder {
    ...
    public AssemblyConnectorBuilder(final Root astModel,
    ...
    public static Connector createAssemblyConnector(
            final ComposedStructure parentComponent,
            final OperationRequiredRole requiredRole,
            final OperationProvidedRole providedRole,
            final RepositoryComponent requiredComponentInstance,
            final RepositoryComponent providedComponentInstance) {

        final AssemblyConnector newConnector = createAssemblyConnectorEntity(
        ...
        final AssemblyContext providingAssemblyContext = findAssemblyContext(
                parentComponent, providedComponentInstance);
        newConnector
        .setProvidingAssemblyContext_AssemblyConnector(providingAssemblyContext);

        final AssemblyContext requiringAssemblyContext = findAssemblyContext(
                parentComponent, requiredComponentInstance);
        newConnector
    ...
    public static Connector createAssemblyConnector(
            ...
            final OperationRequiredRole requiredRole,
            final OperationProvidedRole providedRole,
            final AssemblyContext requiredComponentType,
            final AssemblyContext providedComponentType) {
    ...
    private static AssemblyConnector createAssemblyConnectorEntity(
            final ComposedStructure parentComponent,
            final NamedElement requiredComponentType,
            final NamedElement providedComponentType) {
        ...
        final AssemblyConnector newConnector = CompositionFactory.eINSTANCE
    ...
    private static AssemblyContext findAssemblyContext(
        ...
        boolean found = false;
        for (final AssemblyContext subcomponentInstance : parentComponent
